...
insert  into `main`(`id`,`name`,`type`,`number`,`user_password`) values (1,'张三',1,12405008,'123'),(2,'李四',1,16405008,'qwe123'),(3,'王五',2,11407001,'111222333'),(4,'汪国岩',3,19930525,'19930525'),(5,'王彦春',2,123111,'111111'),(6,'李云',2,123123,'111'),(7,'王建',2,111222,'1231'),(8,'吴松',2,1233112,'11122');
...
insert  into `t_lab_order`(`lab_id`,`uid`,`start_time`,`end_time`,`status_id`,`reason`) values (1,6,'1111','12112',2,'6');
