...
(function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        ...
        if (this.options.striped) {
            this.$el.addClass(this.options.stripedClass);
        }
...
(function () {
    /**
     *@description: 统一修改 打开子表按钮图标 表格条纹颜色
     *@author:tudecai
     */
    $.extend($.fn.bootstrapTable.defaults, {
        icons: {
            detailOpen: 'fa fa-th-list',//打开子表按钮图标
            detailClose: 'glyphicon-minus icon-minus'
        },
        stripedClass : 'ibcpTableStriped'//表格条纹颜色 样式类在 bootsrap-table.css文件 底部
    });
})();
