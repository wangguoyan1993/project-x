...
;!function(){
  ...
  */
  ...
  Class.prototype.render = function(){
    ...
    //给外部提供一个渲染前的方法
    //在渲染前可以改一些配置。比如修改最大最小值的限制等。
    //author: tudecai  2018-1-9
    typeof options.beforeRender === 'function' && options.beforeRender(options);
  ...
  Class.prototype.checkDate = function(fn){
    ...
    ,value = that.isInput(elem) ? (elem.value === "N/A" ? "" : elem.value) : (options.position === 'static' ? '' : elem.innerHTML)
